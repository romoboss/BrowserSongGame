...
globalThis.location = { search: "?theme=dark-blue&limit=18" };
...
test("settings loads, applies, and stores appearance themes", () => {
    ...
    assert.equal(preservedLink.getAttribute("href"), "./index.html?theme=dark-blue&limit=18");
    ...
    assert.equal(preservedLink.getAttribute("href"), "./index.html?theme=dark-purple&limit=18");
    ...
    assert.equal(preservedLink.getAttribute("href"), "./index.html?theme=dark-purple&limit=25");
